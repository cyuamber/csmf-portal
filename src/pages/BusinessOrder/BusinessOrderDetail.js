...
class BusinessOrderDetail extends Component {
    ...
    handleAddArea = () => {
        ...
        formItem.push('area' + formItem.length)
            ...
            if (item.key === 'businessName') {
                ...
                return (
                    formItem.map((it, index) => {
                        ...
                        return (<Col span={24} key={it}>
                            <Col span={8}>
                                <Item {...formItemLayout}>
                                    {getFieldDecorator('province'+it, this.getRules('Please select a region'))(
                            ...
                            <Col span={4}>
                                <Item wrapperCol={{ span: 22, offset: 0 }}>
                                    {getFieldDecorator('city'+it, this.getRules('Please select a region'))(
                            ...
                            <Col span={4}>
                                <Item wrapperCol={{ span: 22, offset: 0 }}>
                                    {getFieldDecorator('county'+it, this.getRules('Please select a region'))(
                            ...
                            <Col span={4}>
                                <Item wrapperCol={{ span: 22, offset: 0 }}>
                                    {getFieldDecorator('street'+it, this.getRules('Please select a region'))(
